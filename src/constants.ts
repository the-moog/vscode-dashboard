...
export const PREDEFINED_COLORS = [
  {
    label: "Green",
    value: "var(--vscode-gitDecoration-untrackedResourceForeground)",
  },
  {
    label: "Brown",
    value: "var(--vscode-gitDecoration-modifiedResourceForeground)",
  },
  {
    label: "Red",
    value: "var(--vscode-gitDecoration-deletedResourceForeground)",
  },
  {
    label: "Grey",
    value: "var(--vscode-gitDecoration-ignoredResourceForeground)",
  },
  ...
  {
    label: "Light Blue",
    value: "var(--vscode-terminal-submoduleResourceForeground)",
  },
];
